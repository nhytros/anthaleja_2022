@hasCharacter()
    <nav class="navbar sticky-bottom navbar-expand-lg navbar-light bg-light shadow">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropup">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="{{ route('litted.communities', 'my') }}">My Community</a></li>
                            <li>
                                                        ...
                                                        @forelse (Auth::user()->character->items as $item)
                                                            <li class="list-group-item">
                                                                <div class="d-flex justify-content-between">
                                                                    <span>{{ $item->name }}</span>
                                                                    <span
                                                                        class="text-end">{{ $item->pivot->quantity }}</span>
                                                                </div>
                                                            </li>
                                                        @empty
